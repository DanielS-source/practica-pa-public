...
INSERT INTO SportTest (name, description, testStart, price, maxParticipants, location, provinceId, sportTestTypeId, participants, timesRated, averageRating, version)
    VALUES ('Prueba 1', 'DescripcionP1', '01-07-2020 16:00:00', 6.99, 500, 'Micasa', 1, 1, 0, 0, 0, 1);

INSERT INTO SportTest (name, description, testStart, price, maxParticipants, location, provinceId, sportTestTypeId, participants, timesRated, averageRating, version)
    VALUES ('Prueba 2', 'DescripcionP2', '01-01-2020 16:00:00', 6.99, 100, 'Micasa', 2, 1, 0, 0, 0, 1);

INSERT INTO SportTest (name, description, testStart, price, maxParticipants, location, provinceId, sportTestTypeId, participants, timesRated, averageRating, version)
    VALUES ('Prueba 3', 'DescripcionP3', '01-02-2020 16:00:00', 6.99, 300, 'Micasa', 1, 2, 0, 0, 0, 1);

INSERT INTO SportTest (name, description, testStart, price, maxParticipants, location, provinceId, sportTestTypeId, participants, timesRated, averageRating, version)
    VALUES ('Prueba 4', 'DescripcionP4', '01-03-2020 16:00:00', 6.99, 2,   'Micasa', 2, 2, 0, 0, 0, 1);
